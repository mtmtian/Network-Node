...
- Treat Stash as the primary client compatibility target. Keep shared YAML within Stash's documented schema; gate Mihomo-only fields behind an explicit client target and regression tests.
